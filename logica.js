document.addEventListener('DOMContentLoaded', function() {
  ...
  $('#form-proceso').validate({
      ...
      messages: {
          subject: 'Por favor ingrese la asignatura que necesite reforzar',
          quantity: 'Por favor ingrese la cantidad de clases que desea solicitar',
      ...
      submitHandler: function(form) {
          ...
          var precioClase = 2500
          // Realizar cálculos para la cotización
          var subtotal = precioClase * quantity;
